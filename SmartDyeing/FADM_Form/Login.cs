...
namespace SmartDyeing.FADM_Form
{
    public partial class Login : Form
    {
        public Login()
        {
            ...
            if (Lib_Card.Configure.Parameter.Other_Language == 0)
            {
                ...
                SmartDyeing.FADM_Object.Communal._dic_errModbusNoNew.Add(13301, "天平通讯异常");
                SmartDyeing.FADM_Object.Communal._dic_errModbusNoNew.Add(13302, "天平开机未拿走废液桶");
            ...
            else
            {
                ...
                SmartDyeing.FADM_Object.Communal._dic_errModbusNoNew.Add(13301, "Abnormal communication on the balance");
                SmartDyeing.FADM_Object.Communal._dic_errModbusNoNew.Add(13302, "The balance was turned on but the waste liquid tank was not taken away");
        ...
        private void LoadPar()
        {
            ...
            //if (Lib_Card.Configure.Parameter.Other_Language == 0)
            //    myAlarm = new FADM_Object.MyAlarm(1 + "号母液瓶液量", "普通针检", true, 1, true);
            //else
            //    myAlarm = new FADM_Object.MyAlarm("The liquid level in bottle " + 1 + " is too low. Do you want to continue the needle inspection? " +
  ...
  */
            ...
            int[] ia_array = {i_d0,i_d0_0,i_d2,i_d2_2,i_d4,i_d4_4,i_d6,i_d6_6,i_d8,i_d8_8,i_d10,i_d10_10,i_d12,i_d12_12,
                ...
                i_d110,i_d110_110,i_d112,i_d112_112};
            ...
            int[] ia_iarray = {i_i0,i_i0_0,i_i2,i_i2_2,i_i4,i_i4_4,i_i6,i_i6_6,i_i8,i_i8_8,i_i10,i_i10_10,i_i12,i_i12_12,
                ...
                i_i56,i_i56_56,i_i58,i_i58_58,i_i60,i_i60_60,i_i62,i_i62_62,i_i64,i_i64_64,i_i66,i_i66_66,i_i68,i_i68_68,i_i70,i_i70_70,i_i72,i_i72_72,i_i74,i_i74_74};
        ...
        //        goto lab814;
            ...
            //开料机配置
              try
              {
                ...
                //  if (Lib_SerialPort.HMI.BrewHMI._i_state == 0)
                //  {
        ...
        private void BtnLogOn_Click(object sender, EventArgs e)
        {
            ...
            FADM_Object.Communal._fadmSqlserver.ReviseData(
                                          "UPDATE dye_details SET Cooperate = 0 WHERE Cooperate in(5,6,7,8) ;");
            FADM_Object.Communal._fadmSqlserver.ReviseData(

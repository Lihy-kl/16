...
namespace SmartDyeing.FADM_Form
{
    public partial class BrewingStep : Form
    {
        ...
        public BrewingStep(string s_stepNum, string s_technologyName, string s_proportionOrTime, string s_brewingCode, bool b_insertOrUpdate, BrewingProcess _Page_BrewingProcess)
        {
            InitializeComponent();
